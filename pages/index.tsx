      ...
      <section className="px-4">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="flex-1 space-y-6">
            <h1 className="text-primary text-4xl md:text-5xl font-extrabold">
        ...
        <div className="max-w-6xl mx-auto mt-16 flex flex-col md:flex-row justify-between items-start gap-12">
          <div className="flex-1 text-center">
            <h2 className="text-primary text-4xl font-bold">Pour qui ? Pour quoi ?</h2>
            <div className="flex flex-col md:flex-row justify-center gap-8">
              <div className="flex flex-col items-center space-y-2 p-4 w-48">
                <Users className="text-primary" size={70} />
                <h3 className="text-primary text-lg font-semibold">Citoyens</h3>
                <p className="text-primary text-sm text-center">Améliorer ses relations personnelles</p>
              </div>
              <div className="flex flex-col items-center space-y-2 p-4 w-48">
                <Handshake className="text-primary" size={70} />
                <h3 className="text-primary text-lg font-semibold">Professionnels</h3>
                <p className="text-primary text-sm text-center">Accompagner et sensibiliser</p>
              </div>
            </div>
          </div>
          ...
          <div className="relative flex-1 max-w-md bg-[#fde3bc] rounded-xl p-6 shadow-md">
            ...
            <h2 className="text-xl font-bold text-primary mb-2">Notre mission</h2>
